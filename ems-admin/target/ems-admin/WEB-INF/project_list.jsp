...
<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container">
        <button class="layui-btn layui-btn-sm" lay-event="add">合同上传</button>
...
<script>
    layui.use(['table','form','upload'], function() {
        ...
        table.render({
            elem: '#tableId',
            url: '/project?method=selectByPage',
            toolbar: '#toolbarDemo',
            page: true,
            height: '315px',
            cols: [[
                ...
                // 模板 - 函数写法
                {field: 'projectProgress' , title: '项目进度'},
                {field: 'projectSize' , title: '项目规模'},
                {field:'status',title: '状态', width:85,templet: '#stausSwitchId'},
                {field: 'createTime' , title: '项目开始时间'},
                {field: 'endTime' , title: '项目结束时间'},
                {field: 'teamName' , title: '项目负责小组'},
